    ...
    <main className="min-h-screen bg-bg text-text flex flex-col items-center justify-center p-6 text-center">
      <div className="max-w-md w-full bg-surface border border-surface/80 rounded-card p-6 shadow-xl flex flex-col items-center space-y-4">
        ...
        <button
          type="button"
          disabled
          aria-label="Start scanning (Camera scan ready to be wired)"
          className="w-full py-3 px-4 rounded-chip bg-accent/20 text-accent font-semibold text-sm cursor-not-allowed border border-accent/40"
        >
          Scanner Scaffolding Ready
        </button>
      </div>
    </main>
  );
